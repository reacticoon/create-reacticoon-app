module.exports = cli => {
  ...
  cli.injectPrompt({
    ...
    message: `Pick a CSS pre-processor${
      process.env.REACTICOON_API_MODE ? "" : ` (${notice})`
    }:`,
    description: `${notice}.`,
    choices: [
      ...
      // In @vue/create-reacticoon-app there're still codes that accepts 'sass' as an option value, for compatibility reasons,
